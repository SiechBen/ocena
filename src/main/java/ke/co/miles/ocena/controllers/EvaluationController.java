 ...
 * @author Ben Siech
 */
@WebServlet(name = "EvaluationController", urlPatterns = {"/evaluationArena", "/updateCourses", "/updateDegrees", "/setCourse", "/retrieveEvaluationQuestions", "/performEvaluation", "/evaluationComplete", "/downloadReports"})
        ...
        if (adminSession == true || adminSession == false) {
            ...
            switch (path) {
                ...
                case "/updateDegrees":
                    ...
                    out.write("<option disabled selected> Select degree </option>");
                ...
                case "/updateCourses":
                    ...
                    for (CourseOfSessionDetails c : courses) {
                        out.write(" <option value=\"" + c.getId() + "\"> " + c.getCourse().getTitle() + " (" + c.getCourse().getCode() + ") </option>\n");
                    }
