 ...
 * @author Ben Siech
 */
public class CourseDetails implements Serializable, Comparable<CourseDetails> {
    ...
    public boolean equals(Object object) {
        ...
        CourseDetails other = (CourseDetails) object;
    ...
    @Override
    public int compareTo(CourseDetails o) {
