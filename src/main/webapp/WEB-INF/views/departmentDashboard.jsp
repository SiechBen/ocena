<%-- 
    Document   : departmentDashboard
    Created on : Jun 15, 2015, 10:23:08 PM
    Author     : Ben Siech
--%>
                            ...
                            <tbody>
                                <c:forEach var="admission" items="${sessionScope.degreesByAdmissionMap.keySet()}">
                                    ...
                                    <c:forEach var="degree" items="${degreesByAdmissionMap.get(admission)}" varStatus="pos">
                                        <tr>
                                            <td onclick="loadWindow('/Ocena/retrieveCoursesAtDashboard?degreeId=${degree.id}')"> &nbsp; </td>
                                            <td onclick="loadWindow('/Ocena/retrieveCoursesAtDashboard?degreeId=${degree.id}')"> ${pos.count} </td>
                                            <td onclick="loadWindow('/Ocena/retrieveCoursesAtDashboard?degreeId=${degree.id}')"> ${degree.name} </td>
